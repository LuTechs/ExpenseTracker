(function () {
    ...
    var modalTemplateUrl = "home/form";

    var expenseManagerControllers = angular.module("ExpenseManagerModule", []);

    expenseManagerControllers.controller("ItemListCtrl",
    [
        "$scope", "$uibModal", "spinFactory", "expenseFactory", "uiblockFactory", "$timeout",
        function ($scope, $uibModal, spinFactory, expenseFactory, uiblockFactory, $timeout) {
            ...
            $scope.pageChanged = function () {
                ...
                if ($scope.filterOpts.filterText) {
                    ...
                    expenseFactory
                        .getExpenseBySearchTextWithPage($scope.pagingOptions.pageSize,
            ...
            $scope.$watch("filterOpts.filterText",
